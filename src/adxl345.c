...
void adxl345_Init(void) {
	adxl345_WriteDataFormat(
														ADXL345_DATA_SELFTEST_DISABLE,
														ADXL345_DATA_SPI_4,
														ADXL345_DATA_INT_INVERT_DISABLE,
														ADXL345_DATA_FULLRES_DISABLE,
														ADXL345_DATA_JUSTIFY_RIGHT,
														ADXL345_DATA_RANGE_8G
													);
	adxl345_WriteINTEnable(
													ADXL345_INT_DATARDY_ENABLE,
													ADXL345_INT_SINGLETAP_DISABLE,
													ADXL345_INT_DOUBLTAP_DISABLE,
													ADXL345_INT_ACTIVITY_DISABLE,
													ADXL345_INT_INACTIVITY_DISABLE,
													ADXL345_INT_FREEFALL_DISABLE,
													ADXL345_INT_WATERMARK_DISABLE,
													ADXL345_INT_OVERRUN_DISABLE
												);
	adxl345_WriteFIFOCtl(ADXL345_FIFO_BYPASS, ADXL345_TRIG_INT1, ADXL345_SAMPLE_WATERMARKDISABLE);
	adxl345_WritePWRCtl(ADXL345_LINK_DISABLE,ADXL345_ASLEEP_DISABLE,ADXL345_MEASURE_ENABLE,ADXL345_SLEEP_DISABLE,ADXL345_WAKE_8HZ);
}


/*
 * @brief: Perforn ADXL345 module self-test
 * @param[in]: none
 * @param[out]: 1 if successful, 0 if not
 */
void adxl345_selfTest(int16_t *xdata, int16_t *ydata, int16_t *zdata) {
	/*
	adxl345_WriteDataFormat(
														ADXL345_DATA_SELFTEST_ENABLE,
														ADXL345_DATA_SPI_4,
														ADXL345_DATA_INT_INVERT_DISABLE,
														ADXL345_DATA_FULLRES_ENABLE,
														ADXL345_DATA_JUSTIFY_RIGHT,
														ADXL345_DATA_RANGE_8G
													);
	
	adxl345_ReadXYZ(xdata,ydata,zdata);
	adxl345_WriteDataFormat(
														ADXL345_DATA_SELFTEST_DISABLE,
														ADXL345_DATA_SPI_4,
														ADXL345_DATA_INT_INVERT_DISABLE,
